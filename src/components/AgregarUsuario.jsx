...
class AgregarUsuario extends Component{
    constructor(props) {
      ...
      addUser(e) {
        e.preventDefault();
        if(this.state._id) {
          fetch(`https://mercadoscampesinosbackend.herokuapp.com/api/usuarios/${this.state._id}`, {
            method: 'PUT',
            body: JSON.stringify({
          ...
          fetch('https://mercadoscampesinosbackend.herokuapp.com/api/usuarios', {
            method: 'POST',
      ...
      editUser(id) {
        fetch(`https://mercadoscampesinosbackend.herokuapp.com/api/usuarios/${id}`)
          .then(res => res.json())
          .then(data => {
            console.log(data);
            this.setState({
